...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "image/jpeg", "image/png", "image/webp"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for measurement-guides" ON storage.objects FOR SELECT USING (bucket_id = 'measurement-guides');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for measurement-guides" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'measurement-guides');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for measurement-guides" ON storage.objects FOR UPDATE USING (bucket_id = 'measurement-guides');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for measurement-guides" ON storage.objects FOR DELETE USING (bucket_id = 'measurement-guides');`
    ];
