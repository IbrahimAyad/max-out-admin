...
Deno.serve(async (req) => {
    ...
    bucketConfig.file_size_limit = 8388608;
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for style-inspiration" ON storage.objects FOR SELECT USING (bucket_id = 'style-inspiration');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for style-inspiration" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'style-inspiration');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for style-inspiration" ON storage.objects FOR UPDATE USING (bucket_id = 'style-inspiration');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for style-inspiration" ON storage.objects FOR DELETE USING (bucket_id = 'style-inspiration');`
    ];
